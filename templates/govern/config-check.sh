...
for k in GOVERN_MERGE_REPOS GOVERN_LOCAL_FIRST_REPOS GOVERN_WORKER_MODEL \
         ...
         GOVERN_BATCH_MAX \
         GOVERN_DETERMINISTIC GOVERN_DETERMINISTIC_MAX_FILES \
         GOVERN_DETERMINISTIC_VERIFY_CMD GOVERN_DETERMINISTIC_VERIFY_REQUIRED \
         ...
         GOVERN_RUN_MAX_TOKENS GOVERN_SELFREF_MAX_PER_RUN GOVERN_PRODUCT_FIRST \
