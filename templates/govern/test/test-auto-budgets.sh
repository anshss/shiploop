...
# `--enforce-budgets` is REPORT ONLY for CLAUDE.md on every call, bare or from this flush: it
...
# size check exits 3 (govern-bookkeep.sh's own documented alarm path). Nothing is ever edited.
