...
# _GOVERN_EDP_SUPPORTED=1 + _GOVERN_TOOLS_SUPPORTED=1: skip BOTH --help capability probes. Each
# one invokes $claude_bin, so an un-seeded probe is an extra fake-claude call — the --help capability probe — the stub claude below is a
...
# _GOVERN_EDP_SUPPORTED=1 + _GOVERN_TOOLS_SUPPORTED=1: skip BOTH --help capability probes. Each
# one invokes $claude_bin, so an un-seeded probe is an extra fake-claude call — the --help capability probe — this stub always returns the
...
# _GOVERN_EDP_SUPPORTED=1 + _GOVERN_TOOLS_SUPPORTED=1: skip BOTH --help capability probes. Each
# one invokes $claude_bin, so an un-seeded probe is an extra fake-claude call — the --help capability probe (see earlier occurrences in this
