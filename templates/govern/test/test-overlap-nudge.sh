...
assert_contains "$out" "expect overlapping exploration if both are dispatched" \
  "A2: the nudge is informational only, never instructs batching into one dispatch"
